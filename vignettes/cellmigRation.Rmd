...
operations. A theoretical upper bound to this argument would be the number 
of threads in your CPU ---which you can check with `parallel::detectCores()`---, 
but it is considered good practice to leave at least one thread for 
